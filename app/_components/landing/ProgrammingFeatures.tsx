        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {programmingFeatures.map((feature, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group w-full aspect-[3/4] min-h-80 rounded-2xl relative overflow-hidden transition-all duration-300 border border-primary-500/20 hover:border-primary-500/40 bg-background-700 shadow-xl hover:shadow-primary-500/10"
            >
              <div className="p-5 relative z-10">
                <div className="font-mono text-xs uppercase text-primary-300 tracking-widest mb-1">
                  {feature.tag}
                </div>
                <div className="text-xl xl:text-2xl text-text-high font-bold leading-tight text-balance">
                  {feature.title}
                </div>
              </div>
              <div
                className="absolute inset-0 bg-cover opacity-50 group-hover:opacity-40 transition-opacity duration-300"
                style={{
              ...
              />
              <div
                className="absolute inset-0 bg-cover opacity-0 group-hover:opacity-40 transition-opacity duration-300"
                style={{
                  backgroundImage: `url(${feature.imgPath})`,
